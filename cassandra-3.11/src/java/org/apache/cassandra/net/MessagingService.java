...
public final class MessagingService implements MessagingServiceMBean
{
    ...
    public enum Verb
    {
        ...
        READ_REQUEST_RESPONSE, // HK
        PAXOS_PREPARE_RESPONSE, // HK
        PAXOS_PROPOSE_RESPONSE, // HK
        PAXOS_COMMIT_RESPONSE, // HK
    ...
    {{
        ...
        put(Verb.READ_REQUEST_RESPONSE, Stage.REQUEST_RESPONSE); // HK
        put(Verb.PAXOS_PREPARE_RESPONSE, Stage.REQUEST_RESPONSE); // HK
        put(Verb.PAXOS_PROPOSE_RESPONSE, Stage.REQUEST_RESPONSE); // HK
        put(Verb.PAXOS_COMMIT_RESPONSE, Stage.REQUEST_RESPONSE); // HK
    ...
    {{
        ...
        put(Verb.READ_REQUEST_RESPONSE, CallbackDeterminedSerializer.instance); // HK
        put(Verb.PAXOS_PREPARE_RESPONSE, CallbackDeterminedSerializer.instance); // HK
        put(Verb.PAXOS_PROPOSE_RESPONSE, CallbackDeterminedSerializer.instance); // HK
        put(Verb.PAXOS_COMMIT_RESPONSE, CallbackDeterminedSerializer.instance); // HK
    ...
    public static final EnumSet<Verb> DROPPABLE_VERBS = EnumSet.of(Verb._TRACE,
            ...
            Verb.READ_REQUEST_RESPONSE, // HK
            Verb.PAXOS_PREPARE_RESPONSE, // HK
            Verb.PAXOS_PROPOSE_RESPONSE, // HK
            Verb.PAXOS_COMMIT_RESPONSE, // HK
            Verb.BATCH_STORE,
            Verb.BATCH_REMOVE);
